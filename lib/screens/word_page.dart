...
import 'package:guess_it/models/word.dart';
...
class _WordPageState extends State<WordPage> {
  ...
  Future<void> fetchWord() async {
    ...
    game = Word.fromJson(data);

    enteredGuesses = [
      for (int i = 0; i < game.numOfChances; i++) ''.padRight(game.word.length)
    ];
  ...
  void handleGuess() {
    if (textController.text.toLowerCase() == game.word) {
      ...
      currentGuess++;
      if (currentGuess == game.numOfChances) {
        setState(() {
                    ...
                    Stack(children: [
                      GestureDetector(
                        ...
                        child: Column(children: [
                          for (int i = 0; i < game.numOfChances; i++)
                            Column(
                              children: [
                                Row(
